...
// Scene duration: 14.5s (435 frames)
// Scene starts at global 55.5s
//
// Audio: act4-narration at 0s (11.1s) → ends 11.1s
//
// Visual phases:
//   0-8s     Dashboard mockup (while narration plays)
//   8-14.5s  CTA (narration finishes at 11.1s, CTA holds)
...
export const PeaceOfMindScene: React.FC = () => {
  ...
  // Phase 1: Dashboard (0-8s)
  const dashOut = interpolate(frame, [7.5 * FPS, 8 * FPS], [1, 0], {
    extrapolateLeft: 'clamp', extrapolateRight: 'clamp',
  });

  // Phase 2: CTA (8-14.5s)
  const ctaProgress = spring({
    frame: frame - 8 * FPS, fps,
    ...
    <AbsoluteFill style={{background: `radial-gradient(ellipse at 40% 60%, #fffefb 0%, ${theme.colors.bgWarm} 50%, #f0e8d8 100%)`}}>
      ...
      <div
        style={{
          ...
          gap: 32, padding: '0 100px', opacity: dashOut,
        }}
      >
        {/* Summary card */}
        <GlassCard enterFrame={0.5 * FPS} width={500} style={{
          background: 'rgba(255,255,255,0.94)',
          border: '1px solid rgba(95,122,97,0.1)', padding: 32,
        }}>
          <div style={{
          ...
          <h3 style={{
            fontFamily: theme.fonts.heading, fontSize: 24, color: theme.colors.text, margin: '0 0 16px',
          }}>Maggie had a wonderful week</h3>

          {/* Stats row */}
          <div style={{
            display: 'flex', gap: 24, marginBottom: 20, padding: '12px 0',
            ...
            {[
              ...
              const sp = spring({frame: frame - (1 * FPS + i * 8), fps, config: {damping: 14, stiffness: 130}});
              const show = frame >= 1 * FPS + i * 8;
              return (
            ...
            {HIGHLIGHTS.map((item, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  opacity: show ? ip : 0,
                  transform: `translateX(${(1 - (show ? ip : 0)) * -12}px)`,
                  fontFamily: theme.fonts.body, fontSize: 16, color: theme.colors.text,
                }}>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
          <GlassCard enterFrame={2 * FPS} width={340} style={{
            background: 'rgba(255,255,255,0.9)',
            border: '1px solid rgba(95,122,97,0.08)', padding: 20,
          }}>
            <div style={{
              fontFamily: theme.fonts.body, fontSize: 13,
              color: theme.colors.primary, fontWeight: 600, marginBottom: 8,
          ...
          <GlassCard enterFrame={3 * FPS} width={340} style={{
            background: 'rgba(95,122,97,0.06)',
            border: '1px solid rgba(95,122,97,0.1)', padding: 20,
          }}>
            <div style={{
              fontFamily: theme.fonts.body, fontSize: 13,
      ...
      >
        ...
        <div style={{
          width: 60, height: 3, backgroundColor: theme.colors.accent,
